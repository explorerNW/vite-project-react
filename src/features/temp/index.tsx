  ...
  forwardRef(function Search(props: { search: string }, ref) {
    ...
    const filterList = useMemo(() => {
      return list.filter(item =>
        item.value.toLowerCase().includes(props.search.toLowerCase().trim())
      );
    }, [list]);
    if (!props.search) {
      return <></>;
    ...
    <>
      ...
      >
        ...
        {position !== null && (
          <Tooltip position={position}>
            {' '}
            <span className='flex w-[10rem] h-[10rem]'>hello</span>{' '}
          </Tooltip>
        )}
      </div>
      <div className='flex flex-col'>
      ...
      <div className='flex flex-col'>
        ...
        <span className='flex flex-col'>
          ...
          <span>
            result: [{removeDuplicate([0, 0, 1, 1, 0, 2, 3, 4, 0]).join(',')}]
          </span>
        </span>
        <span className='flex flex-col'>
          <span>removeDuplicate: [0, 0, 1, 1, 0 ,2, 3, 4, 0] </span>
